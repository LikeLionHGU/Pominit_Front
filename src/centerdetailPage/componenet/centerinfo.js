...
function labelFromURL(u, idx = 0) {
  try {
    ...
    if (/blog\.naver\.com|tistory\.com|medium\.com/i.test(host))
      return "블로그";
...
function normalizeCenter(raw) {
  ...
  return {
    ...
    priceImgUrl:
      raw.priceImgUrl ?? raw["가격표 이미지 URL"] ?? raw["가격 이미지"],
...
export default function CenterInfo({ center }) {
  ...
  return (
    <div>
      <ThumbnailWrapper>
        {c.imageUrl && (
          <LeftThumb src={c.imageUrl} alt={c.name || "센터 이미지"} />
        )}
        <Tag>{c.sport}</Tag>
      </ThumbnailWrapper>
      ...
      <InfoWrapper>
        ...
        <InfoRow>
          <Icon>
            ...
            >
              <path
                d="M12.441 0C11.9523 0 11.5524 0.39989 11.5524 0.888644V1.77729H4.44322V0.888644C4.44322 0.39989 4.04333 0 3.55457 0C3.06582 0 2.66593 0.39989 2.66593 0.888644V1.77729H1.77729C0.790893 1.77729 0.00888643 2.57707 0.00888643 3.55457L0 15.9956C0 16.9731 0.790893 17.7729 1.77729 17.7729H14.2183C15.1958 17.7729 15.9956 16.9731 15.9956 15.9956V3.55457C15.9956 2.57707 15.1958 1.77729 14.2183 1.77729H13.3297V0.888644C13.3297 0.39989 12.9298 0 12.441 0ZM14.2183 15.9956H1.77729V7.10915H14.2183V15.9956Z"
                fill="#FF517E"
              />
            </svg>
          </Icon>
        ...
        <InfoRow>
          <Icon>
            ...
            >
              <path
                d="M14.4323 11.1838L12.17 10.9255C11.6267 10.8632 11.0923 11.0502 10.7093 11.4332L9.07041 13.0721C6.54978 11.7895 4.4834 9.73198 3.20082 7.20243L4.84858 5.55466C5.23157 5.17166 5.41862 4.63725 5.35627 4.09393L5.09797 1.8494C4.99109 0.94981 4.23401 0.272888 3.32551 0.272888H1.78464C0.778165 0.272888 -0.0590758 1.11013 0.0032719 2.11661C0.475333 9.72307 6.55869 15.7976 14.1562 16.2696C15.1627 16.332 15.9999 15.4947 15.9999 14.4882V12.9474C16.0088 12.0478 15.3319 11.2907 14.4323 11.1838Z"
                fill="#FF517E"
              />
            </svg>
          </Icon>
        ...
        <InfoRow>
          <Icon>
            ...
            >
              <path
                d="M5.3 8.67289C3.03 8.08289 2.3 7.47289 2.3 6.52289C2.3 5.43289 3.31 4.67289 5 4.67289C6.42 4.67289 7.13 5.21289 7.39 6.07289C7.51 6.47289 7.84 6.77289 8.26 6.77289H8.56C9.22 6.77289 9.69 6.12289 9.46 5.50289C9.04 4.32289 8.06 3.34289 6.5 2.96289V2.27289C6.5 1.44289 5.83 0.772888 5 0.772888C4.17 0.772888 3.5 1.44289 3.5 2.27289V2.93289C1.56 3.35289 0 4.61289 0 6.54289C0 8.85289 1.91 10.0029 4.7 10.6729C7.2 11.2729 7.7 12.1529 7.7 13.0829C7.7 13.7729 7.21 14.8729 5 14.8729C3.35 14.8729 2.5 14.2829 2.17 13.4429C2.02 13.0529 1.68 12.7729 1.27 12.7729H0.99C0.32 12.7729 -0.15 13.4529 0.0999999 14.0729C0.67 15.4629 2 16.2829 3.5 16.6029V17.2729C3.5 18.1029 4.17 18.7729 5 18.7729C5.83 18.7729 6.5 18.1029 6.5 17.2729V16.6229C8.45 16.2529 10 15.1229 10 13.0729C10 10.2329 7.57 9.26289 5.3 8.67289Z"
                fill="#FF517E"
              />
            </svg>
          </Icon>
