...
const SidebarWrap = styled.div`
  /* transform: translateX(-16px);  // transform이 있으면 fixed 모달에 영향이 갈 수 있어요 */
  margin-left: -16px;
  user-select: none;
`;
...
export default function Sidebar() {
  ...
  return (
    <>
      <SidebarWrap>
        <Backbtn>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="183" height="216" viewBox="0 0 183 216" fill="none">
            ...
            <defs>
              <filter id="filter0_d_593_1082" x="0" y="0" width="183" height="216" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
      ...
      {/* 모달은 바깥에서 조건부 렌더링 (포털로 document.body에 붙기 때문에 transform 영향 X) */}
